        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="magnum-panel mb-6 border-amber-300/15 bg-white/5 text-white">
            <CardContent className="p-8">
              ...
              <p className="magnum-copy mb-4">To be eligible for a return, items must be:</p>
          ...
          <Card className="magnum-panel mb-6 border-amber-300/15 bg-white/5 text-white">
            <CardContent className="p-8">
              ...
              <p className="magnum-copy mb-4">The following items cannot be returned:</p>
              <ul className="magnum-copy list-disc pl-6 space-y-2">
          ...
          <Card className="magnum-panel mb-6 border-amber-300/15 bg-white/5 text-white">
            <CardContent className="p-8">
              ...
              <ol className="magnum-copy list-decimal pl-6 space-y-2">
